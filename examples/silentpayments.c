...
int main(void) {
    ...
    /*** Sending ***/
    {
         ...
         *
         *     1. One output to Bob's labelled address (2.0 BTC) 2. Two outputs
         *     for Carol (1.0 and 3.0 BTC)
         *
        ...
        for (i = 0; i < N_TX_OUTPUTS; i++) { ret =
             ...
             */
            recipients[i].index = i; recipient_ptrs[i] = &recipients[i];
        }
    ...
    /*** Receiving ***/
    {
         ...
         * data:
         *
         *     1. The transaction inputs, `tx_input_ptrs` 2. The transaction
         *     outputs, `tx_output_ptrs`
         *
