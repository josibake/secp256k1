...
static void test_recipient_api(void) {
    secp256k1_silentpayments_recipient_prevouts_summary pd; /* prevouts_summary */
    secp256k1_silentpayments_recipient_prevouts_summary md; /* malformed prevouts_summary */
