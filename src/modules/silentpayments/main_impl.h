...
int secp256k1_silentpayments_recipient_scan_outputs(
    ...
    secp256k1_silentpayments_create_shared_secret(ctx, shared_secret, &prevouts_pubkey_sum_ge, &rsk_scalar);
    ...
    while (1) {
        ...
        secp256k1_silentpayments_create_output_tweak(&output_tweak_scalar, shared_secret, k);
